...
The deposit is \textbf{6.4 MB in 139 files}, with \texttt{MANIFEST.md5} covering every one of them
and \texttt{make verify} checking all 139 against it. \textbf{It has no DOI, and this paper prints
...
is 6.4 MB, carries an md5 manifest for every file, and re-derives every number
