...
|---|---|---|---|
| **TMLR** | **best** | **~0.6–0.7 (297, judgement, after the `cgw1` headline rewrite)** **[SUPERSEDED: 0.80]** | No novelty bar, no length cap; "claims supported" + "of interest" both strongly met. The pre-registered self-reversal reaches the abstract |
