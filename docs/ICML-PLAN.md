...
### 4a. THE LIVE QUEUE (CORRECTIONS 297) — at most three, ranked; **all three REGISTERED AND LAUNCHED 2026-09-22 (299–301), plus 1.14 (`cvl1`, 303) and the two α-independent batches (`cai1` 306, `crd1` 307); ranks 2 and 3 LANDED (309 `crt1` WEAKENED-TO-TIE, 310 `csh1` HORIZON-DOES-NOT-REPRODUCE); off-queue 1.14 LANDED (312 `cvl1` VAL-DIFFERS-UNRESOLVED + SELECT-SAME, PARTIAL); rank 1 LANDED (315 `g3b` UNRESOLVED-BOXBOUND-W4 + SCALAR-BEATS-BEST + DENOM-HOLDS)** *[was: none landed (`crt1` 36 / 36 COMPLETED, unscored)]*
