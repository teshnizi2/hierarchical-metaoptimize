...
Updated 8 Sep 2026 (**cycle 145**, verification). Detail lives here; chat stays short.
Authority: `docs/CORRECTIONS.md` (highest number wins, now **183**) > `docs/FINDINGS.md` > everything else.
